...
const uranoObject = new NEObject(9, "Uranus", 50724, 0, 6.81 * 1000, 130, 'uranus.jpg', 0.77); // 0.77° de inclinação
const netunoObject = new NEObject(10, "Neptune", 49244, 0, 5.43 * 1000, 160, 'neptune.jpg', 1.76); // 1.76° de inclinação
