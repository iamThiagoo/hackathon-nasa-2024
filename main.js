...
// Objetos
const mercuriObject = new NEObject(2, "Mercury", 4880 / sizeScaleFactor, " asdadas asdsad", 0, 47.87 * 1000, 6, 'mercury.jpg', 7.0); // 7.0° de inclinação
const venusObject = new NEObject(3, "Venus", 12104 / sizeScaleFactor, " asdadas asdsad", 0, 35.02 * 1000, 7, 'venus.jpg', 3.39); // 3.39° de inclinação
...
const marteObject = new NEObject(6, "Mars", 6779 / sizeScaleFactor, " asdadas asdsad", 0, 24.077 * 1000, 10, 'mars.jpg', 25.19); // 25.19° de inclinação
const jupiterObject = new NEObject(7, "Jupiter", 139820 / sizeScaleFactor, " asdadas asdsad", 0, 13.07 * 1000, 16, 'jupiter.jpg', 3.13); // 3.13° de inclinação
const saturnoObject = new NEObject(8, "Saturn", 116460 / sizeScaleFactor, " asdadas asdsad", 0, 9.69 * 1000, 25, 'saturn.jpg', 26.73); // 26.73° de inclinação
const uranoObject = new NEObject(9, "Uranus", 50724 / sizeScaleFactor, " asdadas asdsad", 0, 6.81 * 1000, 32, 'uranus.jpg', 0.77); // 0.77° de inclinação
const netunoObject = new NEObject(10, "Neptune", 49244 / sizeScaleFactor, " asdadas asdsad", 0, 5.43 * 1000, 35, 'neptune.jpg', 1.76); // 1.76° de inclinação
