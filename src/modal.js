...
const fixed_data = {
  Sun: {
    ...
    gravity: "274 m/s².",
    translation_period:
      "O Sistema Solar orbita o centro da Via Láctea em cerca de 225-250 milhões de anos.",
    moons: "Nenhuma.",
    temperature:
      "Aproximadamente 5.500 °C na superfície (fotosfera) e até 15 milhões de °C no núcleo.",
    atmosphere:
      "A atmosfera do Sol é extremamente quente e turbulenta, composta por plasma em constante movimento.",
    type: "Estrela anã amarela (tipo espectral G2V).",
    interesting_fact:
      "A luz do Sol leva aproximadamente 8 minutos e 20 segundos para chegar à Terra. Apesar de parecer estático, o Sol está perdendo cerca de 4 milhões de toneladas de massa por segundo, através da fusão nuclear.",
  ...
  Mercury: {
    ...
    moons: "Nenhuma.",
    atmosphere:
      "Extremamente fina, composta principalmente de oxigênio, sódio e hidrogênio.",
    interesting_fact:
      "Mercúrio tem uma órbita altamente elíptica e pode se aproximar do Sol a apenas 46 milhões de km. Curiosamente, um dia em Mercúrio dura quase o dobro de seu ano.",
    sources: [
  ...
  Venus: {
    ...
    temperature:
      "Cerca de 465 °C (temperatura mais alta de todos os planetas).",
    moons: "Nenhuma.",
    atmosphere:
      "Densa, composta principalmente de dióxido de carbono com nuvens de ácido sulfúrico.",
    interesting_fact:
      "Vênus tem uma rotação retrógrada, ou seja, gira no sentido oposto à maioria dos planetas, e sua atmosfera cria um efeito estufa extremo, tornando-o mais quente que Mercúrio, mesmo sendo o segundo planeta mais próximo do Sol.",
    sources: [
      "https://solarsystem.nasa.gov/planets/venus/overview/",
      "https://www.space.com/44-venus-second-planet-from-the-sun.html",
    ],
    name: "🌕 Vênus",
  },
  Earth: {
    ...
    translation_period:
      "Aproximadamente 365,25 dias (tempo que leva para orbitar o Sol).",
    ...
    interesting_fact:
      "A Terra é o único planeta conhecido a abrigar vida. Ela tem um campo magnético que a protege da radiação solar e cósmica, e sua atmosfera tem uma camada de ozônio que filtra os raios ultravioleta prejudiciais.",
    sources: [
  ...
  Moon: {
    ...
    interesting_fact:
      "A Lua sempre mostra o mesmo lado para a Terra, um fenômeno conhecido como rotação síncrona. Os astronautas da Apollo 11 foram os primeiros humanos a pisar na Lua em 1969.",
    sources: [
      "https://solarsystem.nasa.gov/moons/earths-moon/overview/",
      "https://www.space.com/18175-how-was-the-moon-formed.html",
    ],
    name: "🌙 Lua",
  },
  Mars: {
    ...
    atmosphere:
      "Fina, composta principalmente de dióxido de carbono (95%), com traços de nitrogênio e argônio.",
    interesting_fact:
      'Marte é conhecido como o "planeta vermelho" por causa do óxido de ferro (ferrugem) em sua superfície. Ele tem a montanha mais alta do Sistema Solar, Olympus Mons, com 22 km de altura.',
    sources: [
  ...
  Jupiter: {
    ...
    interesting_fact:
      "Júpiter é o maior planeta do Sistema Solar e tem uma tempestade conhecida como a Grande Mancha Vermelha, que é maior que a Terra e existe há pelo menos 400 anos.",
    sources: [
      "https://solarsystem.nasa.gov/planets/jupiter/overview/",
      "https://www.space.com/7-jupiter-largest-planet-in-the-solar-system.html",
    ],
    name: "🌕 Júpiter",
  },
  Saturn: {
    ...
    atmosphere: "Principalmente hidrogênio e hélio.",
    interesting_fact:
      "Saturno é conhecido por seus belos anéis, compostos principalmente de gelo e partículas rochosas. Seus anéis são visíveis da Terra com telescópios amadores.",
    sources: [
  ...
  Uranus: {
    ...
    interesting_fact:
      "Urano gira de lado, com seu eixo inclinado quase 98 graus. Isso significa que, durante parte de sua órbita, um dos hemisférios fica continuamente voltado para o Sol por 42 anos.",
    sources: [
      "https://solarsystem.nasa.gov/planets/uranus/overview/",
      "https://www.space.com/18923-facts-about-uranus.html",
    ],
    name: "🌕 Urano",
  },
  Neptune: {
    ...
    atmosphere: "Principalmente hidrogênio, hélio e metano.",
    interesting_fact:
      "Netuno tem os ventos mais fortes do Sistema Solar, com velocidades que podem ultrapassar 2.000 km/h. Ele também foi o primeiro planeta a ser descoberto por meio de cálculos matemáticos, antes de ser observado.",
    sources: [
      "https://solarsystem.nasa.gov/planets/neptune/overview/",
      "https://www.space.com/18930-neptune-facts-about-the-eighth-planet.html",
    ],
    name: "💫 Netuno",
  },
};
...
async function onObjectClicked(event) {
  if (!passedTutorial) {
    $("#close-modal-button").css({ display: "flex" });
    $("#hide-button").hide();
    passedTutorial = true;
  }
  ...
  if (
    intersects.length > 0 &&
    !intersects[0].object.isStar &&
    !intersects[0].object.material.isOrbit &&
    !isMakingRequests
  ) {
    let index = null;
    ...
    if (intersects[0].object.isAsteroid) {
      ...
      const returnOpenAI =
        await sendMessage(`informações sobre o asteroide, massa densidade, gravidade, Período de translação, Luase, Atmosfera, Curiosidade ${intersects[0].object.name}. monte com base no html
...
function focusOnObject(intersectedObject) {
  ...
  camera.lookAt(targetPosition - distance);
}
